          ...
          {services.map((service) => (
            <Card key={service.id} className="border-white/12 bg-slate-950/60 p-6 sm:p-7">
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <Link href="/contact" className="inline-flex items-center gap-2 text-sm font-semibold text-lime-200 hover:text-lime-100">
                  {service.cta}
              ...
              <div className="mt-6 grid gap-5 lg:grid-cols-2">
                <div className="space-y-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-lime-200">What it is</p>
                    <p className="mt-2 text-sm text-slate-300">{service.whatItIs}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-lime-200">Who it is for</p>
                    <p className="mt-2 text-sm text-slate-300">{service.whoItsFor}</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-lime-200">What Noviqore delivers</p>
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-lime-200">Suggested stack</p>
