  ...
  return (
    <button
      ...
      className={cn(
        ...
        'bg-zinc-950/95 shadow-[0_0_0_1px_rgba(251,191,36,0.2),0_18px_38px_rgba(251,146,60,0.35)] backdrop-blur'
      )}
    >
      <Image
      ...
      />
      <span className="absolute -right-1 -top-1 inline-flex h-6 w-6 items-center justify-center rounded-full border border-amber-200/35 bg-zinc-900/95 text-amber-100">
